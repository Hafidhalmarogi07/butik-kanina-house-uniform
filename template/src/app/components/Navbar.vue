            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-item dropdown-footer">
                        <div class="row">
                            <router-link :to="{name: 'profile'}" class="col-md-4 btn btn-default btn-flat">Profile</router-link>
                            <div class="col-md-4"></div>
                            <a href="#" class="col-md-4 btn btn-default btn-flat" @click.prevent="logout">Logout</a>
                        </div>
                    </div>
                </div>
            </li>
